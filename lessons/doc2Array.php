...
$list = ["name" => 50, "name" => "Alex", "name" => 50]; // Вместо индекса выступает сразу ключ: age, name, 6
$list["name"] = "Bob";
echo $list["name"] . '<br>';
$list[2] = 4;

array_column($list, "name"); // Извлечь значения из ассоциативного массива и записать их в индексированный массив без ключа. (Ключи должны быть одинаковыми)
