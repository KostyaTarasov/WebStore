...
class EmailSender
{
    public static function send(
        ...
        string $subject, // принимается тема письма 'Активация'
        ...
        $body = ob_get_contents(); // Текст для письма берём из буффера, который получен из файла userActivation.php (Добро пожаловать на наш портал!<br> Для активации вашего аккаунта нажмите на ссылку...)
        ob_end_clean();
